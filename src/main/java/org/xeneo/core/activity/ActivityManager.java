...
/*
 * The interface aims on the management of Activities.
 * 
 *
 * @author Stefan Huber
 */
public interface ActivityManager {
     ...
     *
     * @param activityURI The URI of an activity @param caseURI The URI of a
     * case @param taskURIs a Collection of task URIs
     */
